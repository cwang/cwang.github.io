...
Further along the journey, you may add *advisors* and *non-executive directors* who are also likely to be compensated on a mixture of cash and equity basis. The same approach applies when negotiating. I use *contractors* thereafter as the term to cover all recipients of such a compensation structure. 
...
In its purest form, it is a labour contract that obligates founders to compensate contractors for the work they carried out. There is always a cash number to represent the payment due, usually using an agreed market rate. Let’s call it `C`.
